...
int main(int argc, char *argv[]) {
  ...
  */
  ...
  if (complete_part_one) {
    ...
    if (!dist_or_conv) {
      ...
      if (L15c > 0) {
        showline_wlabelmsg(
            "L15c", L15c,
            "Taxable Amount: include this amount on 2019 Form 1040 or 1040-SR, "
  ...
  get_param_single_line(infile, 'b', &complete_part_three,
                        "Complete_Part_Three?");
  GetLine("L19", &L[19]);
  GetLine("L20", &L[20]);
  GetLine("L22", &L[22]);
    ...
    if (L[21] > 0 && L[23] > 0) {
      ...
      if (L25a > 0) {
        showline_wlabelmsg("L25b", L25b,
                           ...
                           "23, or 2019 Form 8915-D, line 14, as applicable");

        L25c = L25a - L25b;
        if (L25c > 0) {
          showline_wlabelmsg(
              "L25c", L25c,
              "Also include this amount on 2019 Form 1040 or 1040-SR, line 4b; "
              "or 2019 Form 1040-NR, line 16b.");
